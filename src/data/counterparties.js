export const COUNTERPARTIES = {
  DB: {
    id:'DB', name:'Deutsche Bank',  rating:'BBB+', region:'EU',
    notional:490,  fairValue:34.2, cva:8.1,  cvaRate:0.0695,
    currentPFE:62, pfeLimit:72,
    cdsSpread:145, lgd:0.65, lambda:0.02231,
    pd1y:2.21, pd5y:10.50,
    ...
    collateral:{posted:18.5,received:8.2,haircut:0.08},
    dsl:50, settlementWindow:2, settlementExposure:18.4,
  },
  CS: {
    id:'CS', name:'Credit Suisse', rating:'BBB',  region:'EU',
    notional:230,  fairValue:22.4, cva:5.3,  cvaRate:0.0957,
    currentPFE:42, pfeLimit:68,
    cdsSpread:185, lgd:0.65, lambda:0.02846,
    pd1y:2.81, pd5y:13.28,
    tenors:['6M','1Y','2Y','3Y','4Y','5Y','7Y','10Y'],
    ...
    collateral:{posted:0,received:6.4,haircut:0.10},
    dsl:30, settlementWindow:1, settlementExposure:8.2,
  },
  BAR: {
    id:'BAR', name:'Barclays',      rating:'BBB+', region:'UK',
    notional:310,  fairValue:28.1, cva:6.2,  cvaRate:0.0903,
    currentPFE:50, pfeLimit:68,
    cdsSpread:120, lgd:0.60, lambda:0.02000,
    pd1y:1.98, pd5y:9.52,
    tenors:['6M','1Y','2Y','3Y','4Y','5Y','7Y','10Y'],
    ...
    collateral:{posted:14.2,received:5.8,haircut:0.06},
    dsl:40, settlementWindow:2, settlementExposure:11.6,
  },
  JPM: {
    id:'JPM', name:'JP Morgan',     rating:'AA-',  region:'US',
    notional:570,  fairValue:19.4, cva:3.8,  cvaRate:0.0333,
    currentPFE:80, pfeLimit:107,
    cdsSpread:45,  lgd:0.55, lambda:0.00818,
    pd1y:0.82, pd5y:3.98,
    tenors:['6M','1Y','2Y','3Y','4Y','5Y','7Y','10Y'],
    ...
    collateral:{posted:22.4,received:12.6,haircut:0.04},
    dsl:80, settlementWindow:1, settlementExposure:6.8,
  },
  BNP: {
    id:'BNP', name:'BNP Paribas',   rating:'BBB+', region:'EU',
    notional:250,  fairValue:24.0, cva:5.8,  cvaRate:0.0960,
    currentPFE:40, pfeLimit:57,
    cdsSpread:110, lgd:0.60, lambda:0.01833,
    pd1y:1.82, pd5y:8.73,
    tenors:['6M','1Y','2Y','3Y','4Y','5Y','7Y','10Y'],
    ee:  [5, 9,14,18,16,12, 8, 4],
    ...
    collateral:{posted:10.8,received:4.2,haircut:0.07},
