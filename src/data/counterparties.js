export const COUNTERPARTIES = {
  DB: {
    ...
    notional: 490,             // context only — NOT used for limit decisions
    fairValue: 34.2,           // current mark-to-market
    cva: 8.1,
    cvaRate: 0.0695,
    currentPFE: 62,            // peak PFE across existing portfolio (from Monte Carlo paths)
    pfeLimit: 72,              // approved credit limit in PFE terms
    tenors:     ['6M','1Y','2Y','3Y','4Y','5Y','7Y','10Y'],
    ee:         [8,14,22,28,25,18,12,7],
    pfe:        [18,32,48,62,56,44,30,16],
    tenorLimits:[40,50,65,75,70,60,48,32],
    wwr: 'HIGH', wwr_rho: 0.72,
    jtd: 34.2, jtdLimit: 50,
